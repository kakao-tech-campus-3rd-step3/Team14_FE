...
interface FestivalInfoManagerApplyInfoCardProps {
  festivalData: FestivalInfo;
}

const FestivalInfoManagerApplyInfoCard = ({ festivalData }: FestivalInfoManagerApplyInfoCardProps) => {
  return (  
    <div className="mb-6 p-4 bg-gray-50 rounded-lg">
    <h3 className="font-semibold text-lg mb-2">신청할 축제</h3>
...
export default FestivalInfoManagerApplyInfoCard;