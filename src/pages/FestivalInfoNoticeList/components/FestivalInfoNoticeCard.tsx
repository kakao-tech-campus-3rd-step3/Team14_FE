...
export const FestivalInfoNoticeCard = ({ notice, noticeRefs, focusNoticeId, isCurrentUserManager, handleEditNotice, handleDeleteNotice, isDeleting }: FestivalInfoNoticeCardProps) => {
