 ...
 */
const SearchContent = () => {
  const { searchQuery, setSearchQuery, searchResults, isLoading, error, canShowResults, refetch } =
    useSearch();
  ...
  return (
    <div className="p-4">
      ...
      {isLoading && <LoadingSpinner size="lg" className="min-h-[400px]" message="검색 중..." />}
