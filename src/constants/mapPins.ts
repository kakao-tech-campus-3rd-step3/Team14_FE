...
const MAP_PINS: Pin[] = [
  ...
  { id: 'jeonbuk', name: '전북', top: 63, left: 38, icon: '/area/jeonbuk.svg', areaId: '37' },
  { id: 'jeonnam', name: '전남', top: 78, left: 30, icon: '/area/jeonnam.svg', areaId: '38' },
  { id: 'gyeongbuk', name: '경북', top: 42, left: 70, icon: '/area/gyeongbuk.svg', areaId: '35' },
  { id: 'daegu', name: '대구', top: 54, left: 68, icon: '/area/daegu.svg', areaId: '4' },
  { id: 'gyeongnam', name: '경남', top: 62, left: 58, icon: '/area/gyeongnam.svg', areaId: '36' },
